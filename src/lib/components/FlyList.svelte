  ...
  {#each rows as entry (entry.slug)}
    ...
    >
      ...
      <div class="min-w-0 flex-1">
        <span
          class="block font-mono text-[13px] font-medium leading-5 text-printer-ink transition-colors group-hover:text-printer-accent group-focus-visible:text-printer-accent dark:text-printer-ink-dark dark:group-hover:text-printer-accent-dark dark:group-focus-visible:text-printer-accent-dark"
        >
          {entry.name}
        </span>
        <p
