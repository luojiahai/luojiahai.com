...
- `content/`: source content. Tech posts in
  `content/tech-posts/YYYY-MM-DD title/` with `en.md` + `zh.md`; life posts in
  `content/life-posts/<slug>/`. Categories in
  `content/categories/{tech,life}.yml`.
...
- Content: new tech posts use `content/tech-posts/YYYY-MM-DD title/` with
  `en.md`, `zh.md`, and images alongside.
